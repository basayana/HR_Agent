...
def generate_answer(client: OpenAI, question: str, context: str) -> str:
    """Generate an answer constrained to the retrieved policy passage."""
    ...
    return response.choices[0].message.content or "I don't have that information in the policy documents"
...
def main() -> None:
    ...
    while True:
        ...
        if source == "No matching policy":
            ...
            answer = generate_answer(client, question, retrieved_passage)
